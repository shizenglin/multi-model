...
class SVHN(dense_design_matrix.DenseDesignMatrixPyTables):
    ...
    data_path = '/home/shizenglin/masterwork/data/svhn/'
    ...
    def __init__(self, which_set, path=None, center=False, scale=False,
        ...
        if path is None:
            path = '/home/shizenglin/masterwork/data/svhn/'
            mode = 'r+'
        else:
            mode = 'r+'
        ...
        super(SVHN, self).__init__(X=data.X, y=numpy.concatenate(data.y),view_converter=view_converter)
    ...
    def make_data(self, which_set, path, shuffle=True):
        ...
        data_y = (data_y - 1).astype(numpy.int)
